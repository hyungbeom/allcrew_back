...
class LocalOperationsDataInitializer(
    ...
    private fun seedCrewAndLinks() {
        jdbcTemplate.update(
            ...
            (?, 'CRW-001', '김민수', '010-1111-0012', '크루', 6, 6, DATE '2026-06-19', 5.0),
            (?, 'CRW-002', '이서연', '010-2222-0034', '크루', 5, 5, DATE '2026-06-18', 4.9),
            (?, 'CRW-003', '박준호', '010-3333-0056', '크루', 4, 4, DATE '2026-06-17', 4.8),
            (?, 'CRW-004', '최유진', '010-4444-0078', '크루', 3, 3, DATE '2026-06-15', 5.0),
            (?, 'CRW-005', '정하늘', '010-5555-0090', '크루', 2, 2, DATE '2026-06-12', 4.7)
            """.trimIndent(),
